...
:DOCS
ROBOCOPY "%_source%\Workspace\PDS\01-Docs" "%_dest%\Innovella\Clients\ATG-PDS\01-Docs" %_what%

:PROJECTS
ROBOCOPY "%_source%\Workspace\Projects\PDS\04.APOLLO" "%_dest%\local\Projects\PDS\04.APOLLO" %_what%
